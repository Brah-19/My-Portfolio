  ...
  return (
    <section id="about" className="scroll-mt-24">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed text-base md:text-lg max-w-3xl">
        ...
        <p>
          {"My journey in tech has taken me from web development internships at iBrand Ghana and Vandzilah Technology to building scalable user interfaces and AI projects, including a machine learning model that predicts car prices from real vehicle data."}
        </p>
      </div>
    </section>
  )
